...
**Apos realizar o processo acima em sua maquina e executar o main.py,existem alguns controles basicos que devem ser destacados,cada um deles estao listados abaixo**
...
- Para para sair de uma tela a outra onde nao tiver escrito  voltar ou sair aperte a tecla esc do teclado.
